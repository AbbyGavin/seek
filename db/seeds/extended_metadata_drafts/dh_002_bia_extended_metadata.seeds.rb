...
disable_authorization_checks do
  ...
  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study Author Affiliation').any?
    study_author_affiliation = ExtendedMetadataType.new(title: 'Bioimage Archive Study Author Affiliation', supported_type: 'ExtendedMetadata')
  ...
  study_author_affiliation_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study Author Affiliation').first

  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study Author metadata').any?
    study_author = ExtendedMetadataType.new(title: 'Bioimage Archive Study Author metadata', supported_type: 'ExtendedMetadata')
  ...
  study_author_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study Author metadata').first

  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study Funding Grant References metadata').any?
    study_funding_grant_references = ExtendedMetadataType.new(title: 'Bioimage Archive Study Funding Grant References metadata', supported_type: 'ExtendedMetadata')
  ...
  study_funding_grant_references_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study Funding Grant References metadata').first

  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study Funding metadata').any?
    study_funding = ExtendedMetadataType.new(title: 'Bioimage Archive Study Funding metadata', supported_type: 'ExtendedMetadata')
  ...
  study_funding_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study Funding metadata').first

  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study Publication metadata').any?
    study_publication = ExtendedMetadataType.new(title: 'Bioimage Archive Study Publication metadata', supported_type: 'ExtendedMetadata')
  ...
  study_publication_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study Publication metadata').first

  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study Link metadata').any?
    study_link = ExtendedMetadataType.new(title: 'Bioimage Archive Study Link metadata', supported_type: 'ExtendedMetadata')
  ...
  study_link_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study Link metadata').first


  unless ExtendedMetadataType.where(title: 'Bioimage Archive Study metadata', supported_type: 'ExtendedMetadata').any?
    bia_study = ExtendedMetadataType.new(title: 'Bioimage Archive Study metadata', supported_type: 'ExtendedMetadata')
...
bia_study_emt = ExtendedMetadataType.where(title: 'Bioimage Archive Study metadata').first
