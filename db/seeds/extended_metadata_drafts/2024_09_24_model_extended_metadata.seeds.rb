...
disable_authorization_checks do
  ...
  # age
  age = ExtendedMetadataAttribute.find_or_initialize_by(title: 'age')
  age.update(
    title: 'age', required: true, sample_attribute_type: int_type,
    description: attribute_descriptions['age'], label: attribute_headings['age'], pos:1
  )

  # clustering coefficient
  clustering = ExtendedMetadataAttribute.find_or_initialize_by(title: 'clustering')
  clustering.update(
    title: 'clustering', required: true, sample_attribute_type: float_type,
    description: attribute_descriptions['clustering'], label: attribute_headings['clustering'], pos:2
  )

  # credibility
  credibility = ExtendedMetadataAttribute.find_or_initialize_by(title: 'credibility')
  credibility.update(
    title: 'credibility', required: true, sample_attribute_type: float_type,
    description: attribute_descriptions['credibility'], label: attribute_headings['credibility'], pos:3
  )
  ...
  # execution_software
  execution_software = ExtendedMetadataAttribute.find_or_initialize_by(title: 'execution_software')
  execution_software.update(
    title: 'execution_software', required: true, sample_attribute_type: cv_type, sample_controlled_vocab: execution_software_cv,
    description: attribute_descriptions['execution_software'], label: attribute_headings['execution_software'], pos:4
  )
  ...
  # ontologies
  ontologies = ExtendedMetadataAttribute.new(title: 'ontologies', required:false,
	  sample_attribute_type: SampleAttributeType.where(title: 'Controlled Vocabulary List').first,
		...
		description: attribute_descriptions['ontologies'], label: attribute_headings['ontologies'], pos:5
		)
  ...
  # scale
  scale = ExtendedMetadataAttribute.find_or_initialize_by(title: 'scale')
  scale.update(
    title: 'scale', required: true, sample_attribute_type: cv_type, sample_controlled_vocab: scale_cv,
    description: attribute_descriptions['scale'], label: attribute_headings['scale'], pos:7
  )




  unless ExtendedMetadataType.where(title:'Edith Model v1', supported_type:'Model').any?
    cmt = ExtendedMetadataType.new(title: 'Edith Model v1', supported_type:'Model')
    cmt.extended_metadata_attributes << age
    cmt.extended_metadata_attributes << clustering
    cmt.extended_metadata_attributes << credibility
    cmt.extended_metadata_attributes << execution_software
    cmt.extended_metadata_attributes << ontologies
    cmt.extended_metadata_attributes << scale
